...
class AllTasksViewModel(private val authRep:AuthRepository, private val taskRep:TasksRepository) : ViewModel() {
    ...
    class AllTaskViewModelFactory(private val authRepo:AuthRepository,
                                  private val taskRep:TasksRepository)
